  ...
  var app = (function () {
      var render = function (st) {
          return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(function (v) {
              return new Data_Maybe.Just(Dec.value);
          }) ])([ Halogen_HTML_Core.text("-") ]), Halogen_HTML_Core.text(Data_Show.show(Data_Show.showInt)(st)), Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(Data_Function["const"](new Data_Maybe.Just(Inc.value))) ])([ Halogen_HTML_Core.text("+") ]) ]);
      };
      ...
      var handleAction = function (v) {
          ...
          throw new Error("Failed pattern match at Main (line 31, column 24 - line 33, column 41): " + [ v.constructor.name ]);
      };
